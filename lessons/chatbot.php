<?php print file_get_contents("http://www.kellylougheed.com/teaching/header.html")?>
	...
	<h1>Chatbot Lesson</h1>

	<p>This lesson introduces students to the inner workings of chatbots through a hands-on lab. It was originally delivered to a group of 8th graders who had previously been exposed to HTML, JavaScript, and DOM manipulation.</p>
	...
	<iframe class="scribd_iframe_embed" title="Chatbot Lesson" src="https://www.scribd.com/embeds/378291444/content?start_page=1&view_mode=scroll&access_key=key-FeWZccV5LT3VllMxV7dM&show_recommendations=true" data-auto-height="false" data-aspect-ratio="0.7729220222793488" scrolling="no" id="doc_27648" width="100%" height="600" frameborder="0"></iframe>

	<p>Chatbot Lab:</p>

	<iframe class="scribd_iframe_embed" title="Chatbot Lab" src="https://www.scribd.com/embeds/378291434/content?start_page=1&view_mode=scroll&access_key=key-5XqrU2cJMQkcqcPvJmHR&show_recommendations=true" data-auto-height="false" data-aspect-ratio="0.7729220222793488" scrolling="no" id="doc_38388" width="100%" height="600" frameborder="0"></iframe>
