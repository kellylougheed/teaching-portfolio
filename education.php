<?php print file_get_contents("header.html")?>
  ...
  <p>I am currently pursuing my M.Ed. in Computer Science Education. In summer 2018, I earned the graduate certificate in Computer Science Education (4.0 GPA) with a capstone project in Android application development. My coursework covered AP Computer Science A with Java, AP Computer Science Principles with App Inventor and Mobile CSP, and computational thinking with Scratch.</p>

  <img src="images/berkeley.jpg" class="side" />

  <h3>University of California, Berkeley</h3>
  <p>In spring 2018, I earned my professional certificate in Software Development and Programming (4.0 GPA). The coursework included programming in Python and C, databases with SQL, electronics, computer architecture, physical computing with the Raspberry Pi, the software development life cycle, networking, and cybersecurity. I also researched internet technologies and the digital divide.</p>
  ...
  <p>I am a self-taught web developer who has been building websites with HTML/CSS and PHP since the early 2000s. I learned JavaScript, Ruby, and Ruby on Rails through online courses and worked professionally as a web developer with PHP, Python, and JavaScript.</p>
