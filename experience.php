<?php print file_get_contents("header.html")?>
	...
	<h3>Full-Time Teaching Positions</h3>

	<h4>Wildwood School - Coding Teacher</h4>
	<p>In fall 2017, I will begin the coding program in the middle and upper school. I am currently developing the curriculum, which will use JavaScript and HTML/CSS in the middle school and Ruby on Rails for an upper school elective.</p>

	<h4>Episcopal School of Jacksonville - Latin Teacher</h4>
	...
	<img src="images/esj.jpg" alt="Classroom at Episcopal School of Jacksonville" />

	<h4>Chandler Preparatory Academy - Latin Teacher</h4>
	...
	<h4>Girl Develop It - Los Angeles</h4>
	<p>In spring 2017, I volunteered as a teaching assistant for introductory programming classes in HTML, CSS, and JavaScript.</p>

	<img src="images/gdi.jpg" alt="Girl Develop It stickers" />

	<h4>The Paideia Institute</h4>
